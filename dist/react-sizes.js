(function (global, factory) {
	...
	(factory((global.ReactSizes = {}),global.React));
...
var getDisplayName = function getDisplayName(Component$$1) {
  return Component$$1.displayName || Component$$1.name || (typeof Component$$1 === 'string' && Component$$1.length > 0 ? Component$$1 : 'Unknown');
};
...
var contextKey = '_ReactSizesConfig_';

var contextTypes = defineProperty({}, contextKey, propTypes.shape({
...
var presets = Object.freeze({
	...
	isGtTablet: isGtTablet,
	isStTablet: isStTablet,
	isStDesktop: isStDesktop,
	isTabletAndGreater: isTabletAndGreater,
	isTabletAndSmaller: isTabletAndSmaller
});

/* eslint-disable no-console */

var withSizes$1 = function withSizes() {
  ...
  return function (WrappedComponent) {
    ...
    return _temp = _class = function (_Component) {
      inherits(ComponentWithSizes, _Component);

      function ComponentWithSizes(props, context) {
        classCallCheck(this, ComponentWithSizes);

        var _this = possibleConstructorReturn(this, (ComponentWithSizes.__proto__ || Object.getPrototypeOf(ComponentWithSizes)).call(this, props, context));
        ...
        _this.getWindowSizesWithFallback = function () {
          var config = _this.context[contextKey] || {};
          ...
          return getWindowSizes({ fallbackHeight: fallbackHeight, fallbackWidth: fallbackWidth });
        };
      ...
      createClass(ComponentWithSizes, [{
        ...
        value: function render() {
          return React__default.createElement(WrappedComponent, _extends({}, this.props, this.state.propsToPass));
        }
      }]);
      return ComponentWithSizes;
    }(React.Component), _class.displayName = 'withSizes(' + getDisplayName(WrappedComponent) + ')', _class.contextTypes = contextTypes, _temp;
  };
};

var withSizes$2 = Object.assign(withSizes$1, _extends({}, presets));

var SizesProvider = function (_Component) {
  inherits(SizesProvider, _Component);

  function SizesProvider() {
    classCallCheck(this, SizesProvider);
    return possibleConstructorReturn(this, (SizesProvider.__proto__ || Object.getPrototypeOf(SizesProvider)).apply(this, arguments));
  }

  createClass(SizesProvider, [{
    key: 'getChildContext',
...
SizesProvider.childContextTypes = contextTypes;

var Conductor = function Conductor(_ref) {
  var children = _ref.children,
      render = _ref.render,
      props = objectWithoutProperties(_ref, ['children', 'render']);
...
var createSizedComponent = function createSizedComponent() {
  ...
  return withSizes$2(mapSizesToProps)(Conductor);
};

exports.withSizes = withSizes$2;
exports.SizesProvider = SizesProvider;
exports.createSizedComponent = createSizedComponent;
exports.presets = presets;
exports['default'] = withSizes$2;
